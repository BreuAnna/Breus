...
if x1<4 || x1>10 
    x1 = input('Введите кол-во приборов (от 4 до 10), x1=');
 % В сообщении используейте фразу:('Введите кол-во приборов (не более 10 !!!), x1=')
 else
...
% (Заполните пропущенные строки самостоятельно!!!)
tn= 1.7;%input('среднее время на отказ (часов), tn= 1,5');
tv= 0.20;%input('среднее время возобновления работоспособности (часов), tv= 0,25');
